# [TÀI LIỆU LẬP TRÌNH TIẾNG VIỆT](/README.md)
> Bộ sưu tập tài liệu học lập trình bằng tiếng Việt, chủ yếu từ các playlist YouTube miễn phí và chất lượng cao. Tài liệu được phân loại rõ ràng theo từng ngôn ngữ/công nghệ như Android, Angular, C++, Java, Python, React, và nhiều hơn nữa, phù hợp cho người mới bắt đầu đến nâng cao. Bao gồm cả cấu trúc dữ liệu, giải thuật, và các lĩnh vực liên quan như Machine Learning, Security. Lý tưởng để tự học, với liên kết trực tiếp đến video hướng dẫn từ các kênh uy tín.
## Nội dung chính
